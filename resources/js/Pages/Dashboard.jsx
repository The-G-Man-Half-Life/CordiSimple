  ...
  return (
    ...
    <div className="flex flex-col md:flex-row w-11/12 h-96 mx-auto mt-12 gap-4 rounded-lg overflow-hidden shadow-xl bg-secondary text-white">
      ...
      <div className="flex flex-col items-center justify-center p-8 text-center md:w-1/3">
        ...
        <a
              href="#contact-us"
              className="inline-flex scroll-smooth items-center px-6 py-2 bg-primary hover:bg-primary/90 text-text rounded-md transition-colors duration-200 font-medium"
            >
      ...
      <div className="relative h-64 md:h-auto md:w-1/3">
        ...
        <div className="text-center mb-12 mt-12">
          <h1 className="text-3xl md:text-4xl font-bold text-text dark:text-text-dark mb-4">
            Check out the <span className="text-title">events</span>
          </h1>
          <p className="text-text/80 dark:text-text-dark/80 max-w-2xl mx-auto">
